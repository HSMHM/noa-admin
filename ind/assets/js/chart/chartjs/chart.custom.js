...
var barData = {
    ...
    datasets: [{
        ...
        strokeColor: AdminConfig.primary,
        highlightFill: "rgba(36, 105, 92, 0.6)",
        highlightStroke: AdminConfig.primary,
        data: [35, 59, 80, 81, 56, 55, 40]
    }, {
        label: "My Second dataset",
        fillColor: "rgba(64, 127, 193, 0.4)",
        strokeColor: AdminConfig.secondary,
        highlightFill: "rgba(64, 127, 193, 0.6)",
        highlightStroke: AdminConfig.secondary,
...
var lineGraphData = {
    ...
    datasets: [{
        ...
        strokeColor: AdminConfig.primary,
        pointColor: AdminConfig.primary,
        ...
        label: "My Second dataset",
        fillColor: "rgba(64, 127, 193, 0.3)",
        strokeColor: AdminConfig.secondary,
        pointColor: AdminConfig.secondary,
        pointStrokeColor: "#fff",
...
var radarData = {
    ...
    datasets: [{
        ...
        strokeColor: AdminConfig.primary,
        pointColor: AdminConfig.primary,
        pointStrokeColor: AdminConfig.primary,
        pointHighlightFill: AdminConfig.primary,
...
var pieData = [{
        value: 300,
        color: AdminConfig.primary,
        highlight: AdminConfig.primary,
        label: "Primary"
    },
    {
        value: 50,
        color: AdminConfig.secondary,
        highlight: AdminConfig.secondary,
        label: "Secondary"
    },
    {
        value: 100,
