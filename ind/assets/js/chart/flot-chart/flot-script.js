...
if ($("#flot-basic-chart").length > 0) {
    ...
    $.plot("#flot-basic-chart", [a, c, d], {
        ...
        colors: [AdminConfig.secondary, AdminConfig.secondary, AdminConfig.secondary, AdminConfig.secondary]
    })
}
    ...
    function plotAccordingToChoices() {
        ...
        if (data.length > 0) {
            $.plot("#toggling-series-flot", data, {
                ...
                colors: [AdminConfig.primary, "#ba895", "#222222", "#717171", "#e2c636", "#d22d3d", "#e6edef"]
...
$(function() {
    ...
    var data = [
        ...
        { color: AdminConfig.secondary, lines: { show: true }, points: data3_points, data: data3, label: "data3" },
        { color: AdminConfig.primary, bars: { show: true, align: "center", barWidth: 0.25 }, data: data4, label: "data4" },
...
$(function() {
    ...
    $.plot('#default-pie-flot-chart', data, {
        ...
        colors: [AdminConfig.primary, "#ba895", "#222222", "#717171", "#e2c636", "#d22d3d", "#efefef"]
    });
