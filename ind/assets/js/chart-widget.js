    ...
    var optionssaleschart = {
        ...
        colors: [AdminConfig.primary, AdminConfig.secondary, '#e2c636'],
        chart: {
            height: 320,
            type: 'radar',
            dropShadow: {
    ...
    var optionsuserchart = {
        ...
        colors: [AdminConfig.primary, AdminConfig.secondary, '#222222', '#e2c636'],
        xaxis: {
            tickAmount: 12,
            type: 'category',
        },
    ...
    var optionscandlestickchart = {
        ...
        plotOptions: {
            candlestick: {
                colors: {
                    upward: AdminConfig.primary,
                    downward: AdminConfig.secondary
                }
            }
        },
        fill: {
