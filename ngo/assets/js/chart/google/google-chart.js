...
function drawBasic() {
    if ($("#column-chart1").length > 0) {
        var a = google.visualization.arrayToDataTable([
            ...
            b = {
                ...
                height: 400,
                width: '100%',
                colors: [AdminConfig.primary, AdminConfig.primary, "#e2c636"]
    ...
    if ($("#pie-chart1").length > 0) {
        ...
        var options = {
            ...
            width: '100%',
            height: 300,
            colors: [AdminConfig.primary, AdminConfig.primary, "#e2c636", "#222222", "#717171"]
        };
    ...
    if ($("#pie-chart2").length > 0) {
        ...
        var options = {
            ...
            width: '100%',
            height: 300,
            colors: [AdminConfig.primary, AdminConfig.secondary, "#e2c636", "#222222", "#717171"]
        };
    ...
    if ($("#pie-chart3").length > 0) {
        ...
        var options = {
            ...
            width: '100%',
            height: 300,
            colors: [AdminConfig.secondary, AdminConfig.primary, "#222222", "#717171", "#e2c636"]
        };
    ...
    if ($("#pie-chart4").length > 0) {
        ...
        var options = {
            ...
            colors: [AdminConfig.primary, AdminConfig.secondary, "#222222", "#717171", "#e2c636", "#d22d3d", "#e6edef", AdminConfig.primary, AdminConfig.secondary, "#222222", "#717171", "#e2c636", "#d22d3d", AdminConfig.primary, AdminConfig.secondary, "#222222", "#717171", "#e2c636", "#d22d3d", AdminConfig.primary, AdminConfig.secondary, "#222222"]
        };
    ...
    if ($("#line-chart").length > 0) {
        ...
        var options = {
            ...
            colors: [AdminConfig.primary, AdminConfig.secondary, "#222222"],
            height: 500,
            width: '100%',
        };
    ...
    if ($("#area-chart1").length > 0) {
        ...
        var options = {
            ...
            width: '100%',
            height: 400,
            colors: [AdminConfig.primary, AdminConfig.secondary]
        };
    ...
    if ($("#area-chart2").length > 0) {
        ...
        var options = {
            ...
            width: '100%',
            height: 400,
            colors: [AdminConfig.primary, AdminConfig.secondary, "#222222", "#717171"]
        };
    ...
    if ($("#bar-chart2").length > 0) {
        var a = google.visualization.arrayToDataTable([
                ...
                ["Copper", 10, AdminConfig.primary],
                ["Silver", 12, AdminConfig.secondary],
                ["Gold", 14, "#222222"],
    ...
    var options = {
        ...
        gantt: {
            ...
            arrow: {
                angle: 100,
                width: 5,
                color: AdminConfig.secondary,
                radius: 0
            },

            palette: [{
                "color": AdminConfig.primary,
                "dark": AdminConfig.primary,
                "light": "#222222"
            }]
