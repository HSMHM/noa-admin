            ...
            case 'normal-sidebar':
                {
                    ...
                    $(".logo-wrapper").find('img').attr('src', '../assets/images/logo/noa-dark.svg');
