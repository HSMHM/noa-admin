(function($) {
    ...
    setTimeout(function() {
        $("#line-chart-sparkline").sparkline([5, 10, 20, 14, 17, 21, 20, 10, 4, 13, 0, 10, 30, 40, 10, 15, 20], {
            ...
            lineColor: AdminConfig.primary,
            fillColor: 'rgba(36, 105, 92, 0.40)',
            highlightLineColor: AdminConfig.primary,
            highlightSpotColor: AdminConfig.primary,
            targetColor: AdminConfig.primary,
            performanceColor: AdminConfig.primary,
            boxFillColor: AdminConfig.primary,
            medianColor: AdminConfig.primary,
            minSpotColor: AdminConfig.primary
        });
    });
    ...
    $("#custom-line-chart").sparkline([0, 5, 10, 7, 25, 20, 30], {
        ...
        tooltipClassname: 'chart-sparkline',
        chartRangeMax: '40',
        lineColor: AdminConfig.secondary,
        fillColor: 'rgba(64, 127, 193, 0.30)',
        highlightLineColor: 'rgba(64, 127, 193, 0.30)',
        highlightSpotColor: 'rgba(64, 127, 193, 0.8)'
    });
})(jQuery);
...
var sparkline_chart = {
    init: function() {
        setTimeout(function() {
            ...
            height: '100%',
            tooltipClassname: 'chart-sparkline',
            barColor: AdminConfig.primary
        }), $("#pie-sparkline-chart").sparkline([1.5, 1, 1, 0.5], {
            type: 'pie',
            width: '100%',
            height: '100%',
            sliceColors: ['#717171', '#222222', AdminConfig.secondary, AdminConfig.primary],
            tooltipClassname: 'chart-sparkline'
            ...
            chartRangeMax: '50',
            lineColor: AdminConfig.secondary,
            fillColor: 'rgba(64, 127, 193 ,0.50)'
