...
var morris_chart = {
    init: function() {
        Morris.Area({
                ...
                ykeys: ['y', 'z'],
                labels: ['Y', 'Z'],
                lineColors: [AdminConfig.secondary, AdminConfig.primary],
            }), Morris.Line({
                ...
                xkey: "x",
                ykeys: ["y", "z", "a"],
                barColors: [AdminConfig.primary, AdminConfig.secondary, "#222222"],
                labels: ["Y", "Z", "A"]
            }), Morris.Bar({
                ...
                Morris.Bar({
                    ...
                    data: b,
                    barColors: [AdminConfig.primary, AdminConfig.secondary],
                    xkey: "period",
                ...
                window.m = Morris.Line({
                    ...
                    labels: ["sin(x)"],
                    parseTime: !1,
                    lineColors: [AdminConfig.primary],
                ...
                Morris.Donut({
                    ...
                    labelColor: AdminConfig.primary,
                    colors: ["rgba(36, 105, 92, 1)", "rgba(64, 127, 193, 1)", "rgba(9,9, 9, 1)", "rgba(113, 113, 113, 1)", "rgba(230, 237, 239, 1)", "rgba(210, 45, 61, 1)", "rgba(36, 105, 92, 1)"],
            ...
            $(function() {
                ...
                Morris.Bar({
                    ...
                    ykeys: ["y", "z", "a"],
                    labels: ["A", "Y", "Z"],
                    barColors: [AdminConfig.primary, AdminConfig.secondary, "#222222", "#717171", "#e2c636", "#d22d3d", "#e6edef"],
                    stacked: !0
                });
            });
    }
