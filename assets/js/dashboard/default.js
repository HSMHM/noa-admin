...
var options = {
    ...
    annotations: {
        yaxis: [{
            y: 50,
            borderColor: AdminConfig.primary,
            label: {
                show: true,
                text: 'Support',
                style: {
                    color: "#fff",
                    background: AdminConfig.primary
                }
            }
        }],
        xaxis: [{
...
var options17 = {
    ...
    colors: [AdminConfig.primary, AdminConfig.secondary, AdminConfig.primary, AdminConfig.secondary],
...
var options55 = {
    series: [{
        ...
        data: [{
            ...
            x: "Apr",
            y: 3000,
            fillColor: AdminConfig.secondary,
        }, {
            x: "May",
            y: 1800
        }, {
